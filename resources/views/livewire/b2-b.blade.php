            ...
            <form wire:submit.prevent="generateInvoice">
                <div class="grid grid-cols-2 gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <label class="block">
                            Adres:
                            <input type="text" wire:model="sellerAddress" class="mt-1 block w-full border rounded-md" readonly />
                        </label>
                        <label class="block">
                            NIP:
                            <input type="text" wire:model="sellerNip" class="mt-1 block w-full border rounded-md" readonly />
                        </label>
                    </div>
                    ...
                    <div>
                        ...
                        <label class="block">
                            Nazwa:
                            <input type="text" wire:model="buyerName" class="mt-1 block w-full border rounded-md" readonly />
                        </label>
                        <label class="block">
                            Adres:
                            <input type="text" wire:model="buyerAddress" class="mt-1 block w-full border rounded-md" readonly />
                        </label>
                        <label class="block">
                            NIP:
                            <input type="text" wire:model="buyerNip" class="mt-1 block w-full border rounded-md" readonly />
                        </label>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-3 gap-4 mb-6">
                    ...
                    <label class="block">
                        Stawka VAT (%):
                        <input type="number" wire:model="taxRate" class="mt-1 block w-full border rounded-md" readonly />
                    </label>
                    <label class="block">
                        Wartość brutto:
                ...
                <div class="grid grid-cols-2 gap-4 mb-6">
                    <label class="block">
                        Numer rachunku:
                        <input type="text" wire:model="bankAccountNumber" class="mt-1 block w-full border rounded-md" readonly />
                    </label>
                    <label class="block">
                        Data wystawienia:
